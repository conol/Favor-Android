...
public class OrderStopTask extends AsyncTask<Void, Void, List<Order>> {

    private OrderStopTask.AsyncCallback mAsyncCallback = null;
    private String mAppToken = null;
    private String mVisitHistoryId = null;

    public OrderStopTask setAppToken(String appToken) {
        mAppToken = appToken;
        return this;
    }

    public OrderStopTask setVisitHistoryId(int visitHistoryId) {
    ...
    public OrderStopTask(AsyncCallback asyncCallback) {
    ...
    protected List<Order> doInBackground(Void... params) {
        ...
        try {
            responseJsonString
                    = Util.Http.put("http://52.196.33.58/api/users/visit_histories/" + mVisitHistoryId + "/order_stop.json", mAppToken, null);
        } catch (Exception e) {
            onFailure(e);
        }
