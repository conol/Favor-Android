...
public class OrderTask extends AsyncTask<Void, Void, List<Order>> {
    ...
    public OrderTask setAppToken(String appToken) {
        mAppToken = appToken;
        return this;
    }

    public OrderTask setVisitHistoryId(int visitHistoryId) {
        mVisitHistoryId = String.valueOf(visitHistoryId);
        return this;
    }

    public OrderTask setOrder(List<Order> orderList) {
    ...
    public OrderTask(AsyncCallback asyncCallback) {
